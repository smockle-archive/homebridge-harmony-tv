function HarmonyTVAccessory(log, config) {
  ...
  this.inputHDMI1Service = new Service.InputSource("hdmi2", "HDMI 2");
  input
  ...
  this.inputHDMI1Service = new Service.InputSource("hdmi3", "HDMI 3");
  input
...
module.exports = { HarmonyTVAccessory };
